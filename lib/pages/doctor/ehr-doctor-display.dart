...
class EletronicHealthRecordForDoctor extends StatefulWidget {
  final String patientEmail;
  const EletronicHealthRecordForDoctor({
    Key? key,
    required this.patientEmail,
  }) : super(key: key);

  @override
  State<EletronicHealthRecordForDoctor> createState() =>
      _EletronicHealthRecordForDoctor();
}

class _EletronicHealthRecordForDoctor
    extends State<EletronicHealthRecordForDoctor> {
  @override
  void initState() {
